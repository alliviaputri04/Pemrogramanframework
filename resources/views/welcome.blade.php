      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              <span class="info-box-icon bg-info elevation-1"><i class="fas fa-light fa-landmark"></i></span>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="progress-group">
                      Jumlah Pegawai
                      <span class="float-right"><b>{{ $jumlahpegawai }}</b>/500</span>
                    ...
                    <div class="progress-group">
                      Jumlah Perusahaan
                      <span class="float-right"><b>{{ $jumlahperusahaan }}</b>/400</span>
                      <div class="progress progress-sm">
                    ...
                    <!-- /.progress-group -->
                    <div class="progress-group">
                      <span class="progress-text">Jumlah Departemen</span>
                      <span class="float-right"><b>{{ $jumlahdepartment }}</b>/40</span>
                      <div class="progress progress-sm">
