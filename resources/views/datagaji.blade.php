...
<div class="content-wrapper">
    ...
    <div class="container">
        <a href="/tambahgaji" class="btn btn-success">Tambah +</a>
            ...
            <table class="table table-dark table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$row->nama}}</td>
                        <td>Rp{{$row->gaji}}</td>
                        <td>Rp{{$row->tunjangan}}</td>
                        <td>{{$row->bulan}}</td>
                        <td>{{$row->tahun}}</td>
                        <td>{{$row->created_at->format('Y-m-d H:i:s') }}</td>
                        <td>{{$row->updated_at->format('Y-m-d H:i:s') }}</td>
                        <td>
                            <a href="/tampilkangaji/{{$row->id}}" class="btn btn-warning">UPDATE</a>
...
<script>
    ...
    swal({
        title: "Yakin ?",
        text: "Kamu yakin akan menghapus data gaji dengan nama "+nama+" ",
        icon: "warning",
        buttons: true,
        dangerMode: true,
    })
